...
USER=b.lhl23prg
MLM_OUT=/scratch/SCWF00175/shared/mlm_adapted_20k
EVAL_OUT=/scratch/SCWF00175/shared/results/full_20k
...
python3 aggregate_results.py \
    ...
    --seeds 1 2 3 \
    --out /scratch/SCWF00175/shared/reports/downstream_results_20k.json
